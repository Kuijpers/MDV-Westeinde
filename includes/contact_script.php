...
$sWebsitenaam = $iwebsite; //vul hier de naam van jouw website in  

$sMail = $iemail; //Het e-mailadres waarnaar de mail word gestuurd. Voor meerdere adressen, scheid de emailadressen met een comma.  
